...
#' example<-export.amira.path(vertices=vertices,filename="example_line") 
#' }
#' @export
export.amira.path<-function(vertices,filename,Lines=c(1:(dim(vertices)[1]-1)-1,-1),path=getwd())
{
